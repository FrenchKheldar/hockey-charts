...
<body>
    ...
    <footer>
        <p>&copy; 2026 Matthieu Masquelet • <a href="about.html">About / À propos</a> • <a href="links.html">Links / Liens</a> • Made with &hearts; for hockey fans.</p>
    </footer>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>About - Hockey Charts</title>
...
<body>
    ...
    <main>
        <div class="panel">
            <h2>English</h2>
            <p>
                Hello, my name is Matthieu Masquelet and I am just a fan of hockey and the NHL. Originally from France, I had the chance to watch my first hockey game at the historic Montreal Forum during a language trip as a teenager. I fell in love with the sport at that moment and once my life path brought me to the United States, I was able to pursue my passion by learning to play and following the Montreal Canadiens, the Atlanta Thrashers, and the Seattle Kraken over the years. This website is my small contribution to this sport and this league.
            </p>
        </div>
        ...
        <div class="panel">
            <h2>Français</h2>
            <p>
                Bonjour, je m'appelle Matthieu Masquelet et je suis juste un fan de hockey et de la LNH. Originaire de France, j'ai eu la chance de voir mon 1er match de hockey à l'ancien Forum de Montréal lors d'un voyage linguistique alors que j'étais adolescent. Je suis tombé amoureux de ce sport à ce moment-là et une fois que mon parcours de vie m'a emmené aux Etats-Unis, j'ai pu poursuivre ma passion en apprenant à jouer et en suivant les Canadiens de Montréal, les Thrashers d'Atlanta et le Kraken de Seattle au fil des ans. Ce petit site web est ma petite contribution à ce sport et à cette ligue.
            </p>
        </div>

        <div class="nav-back">
            <a href="index.html" class="btn-back">← Back to Dashboard / Retour au tableau de bord</a>
        </div>
    </main>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Links - Hockey Charts</title>
...
<body>
    ...
    <header>
        <div class="header-container">
            <h1>Recommended Links / Liens recommandés</h1>
        </div>
    </header>

    <main>
        <div class="panel">
            <h2>Hockey Reference & News</h2>
            <ul>
                <li>
                    <div class="link-title">
                        <a href="https://www.hockey-reference.com" target="_blank" rel="noopener">Hockey-Reference.com</a>
                    </div>
                    <div class="link-desc">
                        The ultimate source for hockey stats, histories, and player records. This site's raw data is the foundation of our franchise database.
                    </div>
                </li>
                <li>
                    <div class="link-title">
                    ...
                    <div class="link-desc">
                        The official website of the National Hockey League. Live scores, news, video highlights, and standings.
                    </div>
                </li>
                <li>
                    <div class="link-title">
                    ...
                    <div class="link-desc">
                        Excellent resource for NHL player contracts, salary cap numbers, and team salary lists.
                    </div>
                </li>
                <li>
                    <div class="link-title">
                        <a href="https://www.eliteprospects.com" target="_blank" rel="noopener">Elite Prospects</a>
                    </div>
                    <div class="link-desc">
...
def main():
    ...
    # 9. Generate interactive web dashboard index.html, about.html, and links.html if requested
    if args.dashboard:
        ...
        about_path = os.path.join(args.output_dir, "about.html")
        with open(about_path, 'w', encoding='utf-8') as f:
            f.write(ABOUT_HTML)
        print(f"📖 About page generated successfully at: {about_path}")

        links_path = os.path.join(args.output_dir, "links.html")
        with open(links_path, 'w', encoding='utf-8') as f:
            f.write(LINKS_HTML)
        print(f"🔗 Links page generated successfully at: {links_path}")

        # Write CNAME file for custom domain support on GitHub Pages
        cname_path = os.path.join(args.output_dir, "CNAME")
        with open(cname_path, 'w', encoding='utf-8') as f:
            f.write("hockey-charts.com\n")
        print(f"🌐 CNAME file generated successfully at: {cname_path}")
        print("💡 Open index.html in your browser to view all-time charts instantly!")
