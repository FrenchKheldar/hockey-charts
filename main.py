...
<body>
    ...
    <footer>
        <p>&copy; 2026 Matthieu Masquelet • <a href="about.html">About / À propos</a> • Made with &hearts; for hockey fans.</p>
    </footer>
...
<body>
    ...
    <footer>
        <p>&copy; 2026 Matthieu Masquelet. Made with &hearts; for hockey fans.</p>
    </footer>
...
def main():
    ...
    # 9. Generate interactive web dashboard index.html and about.html if requested
    if args.dashboard:
